...
export const getClassifiedNumberByLenght = (numberLenght: number): ClassifiedNumber | null => {
...
export const getClassifiedNumberByOrder = (order: NumberOrderType): ClassifiedNumber => {
    switch(order) {
        case "billions":
            return billions;
        case "millions":
